...
// Wi-Fi credentials for White Oyster project
const char* ssid = "OT7";
const char* password = "dIk0aLAm";

// Select camera model (same model for White Oyster project)
...
// Stream handler for White Oyster project
...
// Capture image handler for White Oyster project
...
// Resolution change handler for White Oyster project
...
void setup() {
  ...
  startCameraServer();
  Serial.println("White Oyster Mushroom Camera Ready! Go to: http://192.168.100.193:81/stream");
}
