...
// Wi-Fi credentials for Reishi project
const char* ssid = "OT7";
const char* password = "dIk0aLAm";

// Select camera model (same model for Reishi project)
...
// Stream handler for Reishi project
...
// Capture image handler for Reishi project
...
// Resolution change handler for Reishi project
...
void setup() {
  ...
  startCameraServer();
  Serial.println("Reishi Mushroom Camera Ready! Go to: http://192.168.100.193:81/stream");
}
