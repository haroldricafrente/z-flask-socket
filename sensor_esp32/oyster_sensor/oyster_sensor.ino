...
const char* serverURL = "http://192.168.1.9:5000/data";      // Flask server endpoint
const char* relayControlURL = "http://192.168.1.9:5000/relay";  // Flask server endpoint for relay control
...
void loop() {
  ...
  if (!isnan(temperature) && !isnan(humidity)) {
    ...
    String sensorData = String("{") +
                        "\"sensor_type\":\"oyster\"," +  // Add sensor type
